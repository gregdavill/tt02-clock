...
int main(int, char **)
{
  ...
  GLFWwindow *window = glfwCreateWindow(890, 320, "TinyTapeout2 7 segment clock Simulator", NULL, NULL);
  if (window == NULL)
    return 1;
  ...
  while (!glfwWindowShouldClose(window))
  {
    ...
    // 2. Show a simple window that we create ourselves. We use a Begin/End pair to created a named window.
    {
      ...
      ImGui::Begin("Clock Sim", (bool *)0, ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoMove);
      {
        ...
        ImGui::Button("Hour");
        design_harness.i_hour(ImGui::IsItemActive());
        ImGui::SameLine();
        ImGui::Button("Minute");
        design_harness.i_minute(ImGui::IsItemActive());
        ImGui::SameLine();
      }
      ImGui::End();
